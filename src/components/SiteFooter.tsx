      ...
      <div className="container footer__inner">
        ...
        <div className="footer__col">
          ...
          <div className="footer__links">
            ...
            <a href="https://store.revampfy.in/">Store</a>
          </div>
        </div>
        <div className="footer__col">
          <h4>Company</h4>
        ...
        <div className="footer__col">
          <h4>Contact Us</h4>
          <p><a href="mailto:support@revampfy.in">support@revampfy.in</a></p>
          <p><a href="tel:+918248003564">+91 8248003564</a></p>
        </div>
        <div className="footer__col">
          <h4>Partners</h4>
          <p>Campus and reseller partner programs available across India.</p>
        </div>
      </div>
      <div className="container footer__bottom">
        <p>(c) 2026 Revampfy. All rights reserved.</p>
